...
- [Repository](https://github.com/zakimaths/whiteboard) and [preview release](https://github.com/zakimaths/whiteboard/releases/tag/v0.3.0).
...
Sketch-to-shape, pinned ideas, editable LaTeX + TikZ.
...
These are prepared drafts. Nothing has been posted to X or LinkedIn.
